...
const getAllNotification = async (userId: string): Promise<Notification | null> => {
  try {
...
const getAllNotificationByID = async (notificationID: number): Promise<Notification | null> => {
    try {
